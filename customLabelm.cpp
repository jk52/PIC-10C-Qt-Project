...
customLabelm::customLabelm(QWidget * parent) : QLabel(parent)
{
    connect( this, SIGNAL( clicked() ), this, SLOT( slotClicked() ) );

}

customLabelm::customLabelm(mGameBoard* p, QWidget * parent) : QLabel(parent), t(p)
{
    connect( this, SIGNAL( clicked() ), this, SLOT( slotClicked() ) );

}

void customLabelm::slotClicked()
{

}

void customLabelm::mouseReleaseEvent ( QMouseEvent * event )
{
