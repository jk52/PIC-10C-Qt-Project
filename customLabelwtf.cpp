...
customLabelwtf::customLabelwtf(QWidget * parent) : QLabel(parent)
{
    connect( this, SIGNAL( clicked() ), this, SLOT( slotClicked() ) );

}

customLabelwtf::customLabelwtf(wtfGameBoard* p, QWidget * parent) : QLabel(parent), t(p)
{
    connect( this, SIGNAL( clicked() ), this, SLOT( slotClicked() ) );

}

void customLabelwtf::slotClicked()
{

}

void customLabelwtf::mouseReleaseEvent ( QMouseEvent * event )
{
